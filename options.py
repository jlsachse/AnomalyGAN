...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--w_fra', type=float, default=1, help='Fraud loss weight')
        self.parser.add_argument('--w_app', type=float, default=50, help='Apparent loss weight')
        self.parser.add_argument('--w_lat', type=float, default=1, help='Latent loss weight.')
        self.isTrain = True
        self.opt = None
